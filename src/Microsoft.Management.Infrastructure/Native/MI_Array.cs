...
namespace Microsoft.Management.Infrastructure.Native
{
    ...
    internal class MI_ExtendedArray
    {
        ...
        private MI_ExtendedArrayPtr ptr;
        ...
        public static implicit operator MI_ExtendedArrayPtr(MI_ExtendedArray instance)
        {
            ...
            return new MI_ExtendedArrayPtr() { ptr = instance == null ? IntPtr.Zero : instance.Ptr };
        }
